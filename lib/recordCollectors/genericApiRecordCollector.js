...
function genericRequestApi(sourceSchema) {
  function api(params, callback) {
    ...
    const requestFormBuilderFunction = sourceSchema.requestFormBuilder || _.identity;
    ...
    const formParams = _.pick(params, _.concat(sourceSchema.formParamKeys, _.get(params, 'apiConfig.formParamKeys')));
    ...
    const mergedRequestParams = _.merge({
      ...
      form: requestFormBuilderFunction(formParams),
